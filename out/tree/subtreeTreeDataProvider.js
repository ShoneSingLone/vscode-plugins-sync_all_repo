...
exports.SubtreeTreeDataProvider = void 0;
const vscode = __importStar(require("vscode"));
class SubtreeTreeDataProvider {
    constructor(gitSubtreeManager) {
    ...
    async getSubtreeInfo() {
        return this.gitSubtreeManager.detectSubtrees();
    }
}
exports.SubtreeTreeDataProvider = SubtreeTreeDataProvider;
